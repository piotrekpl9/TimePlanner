...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240531104607_Invitation_Add_User_Adj_T")]
    partial class Invitation_Add_User_Adj_T
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Domain.Group.Entities.Invitation", "Invitations", b1 =>
                        {
                            ...
                            b1.HasOne("Domain.User.Entities.User", "User")
                                .WithOne()
                                .HasForeignKey("Domain.Group.Entities.Group.Invitations#Domain.Group.Entities.Invitation", "UserId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
